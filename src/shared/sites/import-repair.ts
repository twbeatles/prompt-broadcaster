...
function detectBuiltInOverrideAdjustment(
  ...
  const simpleComparisons = [
    ...
    ["verifiedAt", safeText(rawRecord.verifiedAt), sanitized.verifiedAt],
    ["verifiedRoute", safeText(rawRecord.verifiedRoute), sanitized.verifiedRoute],
    ["verifiedAuthState", safeText(rawRecord.verifiedAuthState), sanitized.verifiedAuthState],
    ["verifiedLocale", safeText(rawRecord.verifiedLocale), sanitized.verifiedLocale],
